...
write_tsv(diff_abund_ASO.vs.WT_age2_clean$prevalence %>% filter(grepl("age", metadata)), file.path(output_directories.list$maaslin_outdir, "maaslin3_PREVAL_ASO.vs.WT_age2.tsv"))
write_tsv(diff_abund_ASO.vs.WT_age2_clean$abundance %>% filter(grepl("age", metadata)), file.path(output_directories.list$maaslin_outdir, "maaslin3_ABUND_ASO.vs.WT_age2.tsv"))
...
write_tsv(diff_abund_ASO.vs.WT_age5_clean$prevalence %>% filter(grepl("age", metadata)), file.path(output_directories.list$maaslin_outdir, "maaslin3_PREVAL_ASO.vs.WT_age5.tsv"))
write_tsv(diff_abund_ASO.vs.WT_age5_clean$abundance %>% filter(grepl("age", metadata)), file.path(output_directories.list$maaslin_outdir, "maaslin3_ABUND_ASO.vs.WT_age5.tsv"))
